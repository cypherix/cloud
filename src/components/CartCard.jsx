...
const CartCard = ({ item }) => {
  ...
  return (
    <div>
      <div className="h-80 w-[310px] md:h-72 md:w-[600px] bg-slate-100 dark:bg-[#fbfbfb] dark:hover:bg-[#fdfbff] rounded-2xl hover:shadow-lg mt-[40px] md:mt-[20px]">
        <div className="">
          <div>
            <img
              ...
              <div className="flex justify-evenly gap-x-8 mt-2 md:gap-x-0 md:justify-evenly">
                ...
                <div>
                  <div className="flex gap-x-6">
                    <p className="flex ">
                      <button
                        className="p-1 mr-2 bg-[#dadada] dark:bg-[#c4c4c4] dark:hover:bg-[#a3a3a3] dark:border-none border rounded-lg font-bold w-[30px]"
                      ...
                      <button
                        className="p-1 ml-2 bg-[#dadada] dark:bg-[#c4c4c4] dark:hover:bg-[#a3a3a3] dark:border-none border rounded-lg font-bold w-[30px]"
